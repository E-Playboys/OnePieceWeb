...
namespace OnePiece.Web.Data.Migrations
{
    ...
    [Migration("20170115060749_UpdateTableNames")]
    partial class UpdateTableNames
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OnePiece.Web.Entities.MangaVolume", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OnePiece.Web.Entities.MangaChapter", b =>
                {
                    ...
                    b.HasOne("OnePiece.Web.Entities.MangaVolume", "MangaVolume")
                        .WithMany("MangaChapters")
                        .HasForeignKey("MangaVolumeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
